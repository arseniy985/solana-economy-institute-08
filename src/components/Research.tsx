  ...
  return (
    <section id="research" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Research Reports */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-gray-900 mb-8">Latest Research Reports</h3>
        ...
        {/* Case Studies */}
        <div>
          <h3 className="text-2xl font-bold text-gray-900 mb-8">Success Case Studies</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
